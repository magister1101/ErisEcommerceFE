  ...
  <q-page class="flex flex-center page">
    <div class="loginContainer">
      ...
      <div class="q-ma-md">
        ...
        <q-card-section class="flex flex-center" style="border-bottom: 2px solid #d1edff">
          <p
            class="cursor-pointer"
            @click="router.push('/passwordRecovery')"
...
import { validation } from 'src/components/userViewerUtility'
...
async function login() {
  ...
  try {
    const response = await axios.post(
      `${process.env.api_host}/users/loginUser`,
      {
